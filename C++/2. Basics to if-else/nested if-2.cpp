...
if(a>b)
{
 if(c<d)                        /* now here the above condition is true a>b. so it comes inside and check c<d whick is false so it leaves it.
                                   and go outside and check c>d which is true so it prints perfect. */   
 {
   cout<<"good job"<<endl;
}
   if(c>d)
